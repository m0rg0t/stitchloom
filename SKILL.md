...
- switch between Russian, English, Spanish, and German before and after pattern generation, reload the saved choice, and inspect localized metadata, AI prompts, DMC names, PWA manifests, PDFs, and the 404 page;
